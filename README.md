...
Companion blog to the [Garage Geek Guy YouTube channel](https://www.youtube.com/@garagegeekguy).
...
│   ├── styles/global.css    # Site-wide theme (dark + yellow accent)
